            ...
            <div className="min-h-screen bg-gray-900 text-white font-mono">
                ...
                <section className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 p-12 text-center">
                    ...
                    <p className="text-purple-300 max-w-2xl mx-auto text-lg mb-6">
                        Crea listas personalizadas, valora tus juegos favoritos
                        y comenta junto a otros jugadores. ¡Todo desde un mismo
                        sitio!
                    </p>
                    {!auth?.user && (
                        <div className="flex justify-center gap-4 mt-4">
                            ...
                            <Link
                                href={route("login")}
                                className="px-6 py-3 border border-purple-500 text-purple-300 hover:text-white hover:bg-purple-600 rounded transition"
                            >
                                Iniciar sesión
                            </Link>
                        </div>
                ...
                <section className="py-12 max-w-5xl mx-auto px-4 text-center">
                    <h2 className="text-3xl text-purple-400 font-bold mb-8">
                        ¿Qué puedes hacer?
                    </h2>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-gray-800 p-6 rounded shadow border border-purple-600">
                            <h3 className="text-neon-green text-xl font-semibold mb-2">
                                Crea tus listas
                            </h3>
                            <p className="text-purple-300">
                                Organiza tus juegos favoritos por categorías:
                                completados, en espera, favoritos o como
                                quieras.
                            </p>
                        </div>
                        <div className="bg-gray-800 p-6 rounded shadow border border-purple-600">
                            ...
                            <p className="text-purple-300">
                                Deja tu opinión y valora los juegos que has
                                jugado. Otros usuarios pueden comentarlas.
                            </p>
                        </div>
                        <div className="bg-gray-800 p-6 rounded shadow border border-purple-600">
                            <h3 className="text-neon-green text-xl font-semibold mb-2">
                            ...
                            <p className="text-purple-300">
                                Explora títulos nuevos gracias a nuestras
                                búsquedas por género, puntuación y tendencias.
                            </p>
                        </div>
                    </div>
                </section>
